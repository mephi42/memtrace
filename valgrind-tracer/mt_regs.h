...
DEFINE_SUBREG(guest_RDX, 0, ULong, "rbx"),
DEFINE_SUBREG(guest_RDX, 0, UInt, "ebx"),
DEFINE_SUBREG(guest_RDX, 0, UShort, "bx"),
DEFINE_SUBREG(guest_RDX, 0, UChar, "bl"),
DEFINE_SUBREG(guest_RDX, 1, UChar, "bh"),
